...
<head>
    ...
    <title>{{ $title ?? 'Admin' }} · GoldenSys</title>
...
@php
    $nav = [
        ['group' => 'Operación', 'items' => [
            ...
            ['route' => 'admin.inventario.index', 'label' => 'Inventario', 'match' => 'admin.inventario.*'],
            ['route' => 'admin.pedidos.index', 'label' => 'Pedidos', 'match' => 'admin.pedidos.*'],
            ['route' => 'admin.despachos.index', 'label' => 'Despachos', 'match' => 'admin.despachos.*'],
            ['route' => 'admin.recepciones.index', 'label' => 'Recepciones', 'match' => 'admin.recepciones.*'],
            ['route' => 'admin.perdidas.index', 'label' => 'Pérdidas', 'match' => 'admin.perdidas.*'],
        ]],
        ['group' => 'Gestión', 'items' => [
            ['route' => 'admin.usuarios.index', 'label' => 'Usuarios', 'match' => 'admin.usuarios.*'],
            ['route' => 'admin.reclamos.index', 'label' => 'Reclamos', 'match' => 'admin.reclamos.*'],
            ['route' => 'admin.reportes.index', 'label' => 'Reportes', 'match' => 'admin.reportes.*'],
        ]],
        ['group' => 'Catálogos', 'items' => [
            ['route' => 'admin.productos.index', 'label' => 'Productos', 'match' => 'admin.productos.*'],
            ['route' => 'admin.proveedores.index', 'label' => 'Proveedores', 'match' => 'admin.proveedores.*'],
...
<div class="shell">
    ...
    <aside class="side">
        <a class="side__brand" href="{{ route('admin.dashboard') }}">
            GoldenDrinks
            <em>Admin · GoldenSys</em>
        </a>

        <nav class="side__nav" aria-label="Módulos admin">
        ...
        <div class="side__user">
            ...
            <span>{{ Auth::user()->correo }} · Administrador</span>
