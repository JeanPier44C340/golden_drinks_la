...
<head>
    ...
    <title>{{ $title ?? 'Celador' }} · GoldenSys</title>
...
@php
    $nav = [
        ['group' => 'Operación', 'items' => [
            ['route' => 'celador.dashboard', 'label' => 'Dashboard', 'match' => 'celador.dashboard'],
            ['route' => 'celador.llegadas.create', 'label' => 'Registrar llegada', 'match' => 'celador.llegadas.*'],
            ['route' => 'celador.bodega.index', 'label' => 'En bodega', 'match' => 'celador.bodega.*'],
            ['route' => 'celador.historial.index', 'label' => 'Historial', 'match' => 'celador.historial.*'],
        ]],
    ];
@endphp
<div class="shell">
    ...
    <aside class="side">
        <a class="side__brand" href="{{ route('celador.dashboard') }}">
            GoldenDrinks
            <em>Celador · GoldenSys</em>
        </a>

        <nav class="side__nav" aria-label="Módulos celador">
        ...
        <div class="side__user">
            ...
            <span>{{ Auth::user()->correo }} · Celador</span>
