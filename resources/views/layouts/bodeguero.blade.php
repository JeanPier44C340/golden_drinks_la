...
<head>
    ...
    <title>{{ $title ?? 'Bodeguero' }} · GoldenSys</title>
...
@php
    $nav = [
        ['group' => 'Bodega', 'items' => [
            ['route' => 'bodeguero.dashboard', 'label' => 'Dashboard', 'match' => 'bodeguero.dashboard'],
            ['route' => 'bodeguero.pendientes.index', 'label' => 'Pendientes', 'match' => 'bodeguero.pendientes.*'],
            ['route' => 'bodeguero.inventario.index', 'label' => 'Inventario', 'match' => 'bodeguero.inventario.*'],
            ['route' => 'bodeguero.perdidas.index', 'label' => 'Dañados', 'match' => 'bodeguero.perdidas.*'],
        ]],
    ];
@endphp
<div class="shell">
    ...
    <aside class="side">
        <a class="side__brand" href="{{ route('bodeguero.dashboard') }}">
            GoldenDrinks
            <em>Bodeguero · GoldenSys</em>
        </a>

        <nav class="side__nav" aria-label="Módulos bodeguero">
        ...
        <div class="side__user">
            ...
            <span>{{ Auth::user()->correo }} · Bodeguero</span>
