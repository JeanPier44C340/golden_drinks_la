...
<head>
    ...
    <title>{{ $title ?? 'Repartidor' }} · GoldenSys</title>
...
@php
    $nav = [
        ['group' => 'Ruta', 'items' => [
            ['route' => 'repartidor.dashboard', 'label' => 'Dashboard', 'match' => 'repartidor.dashboard'],
            ['route' => 'repartidor.inventario.index', 'label' => 'Inventario', 'match' => 'repartidor.inventario.*'],
            ['route' => 'repartidor.despachos.index', 'label' => 'Despachos', 'match' => 'repartidor.despachos.*'],
        ]],
    ];
@endphp
<div class="shell">
    ...
    <aside class="side">
        <a class="side__brand" href="{{ route('repartidor.dashboard') }}">
            GoldenDrinks
            <em>Repartidor · GoldenSys</em>
        </a>

        <nav class="side__nav" aria-label="Módulos repartidor">
        ...
        <div class="side__user">
            ...
            <span>{{ Auth::user()->correo }} · Repartidor</span>
