<x-admin-layout title="Inventario">
    <header class="page-head">
        <p class="page-head__eyebrow">HU-ADM-029</p>
        <h1 class="page-head__title">Inventario completo</h1>
        <p class="page-head__lead">Estado de stock, filtros y últimos movimientos del kardex.</p>
    </header>

    <form class="toolbar" method="GET" action="{{ route('admin.inventario.index') }}">
        <div class="field">
            <label for="q">Buscar</label>
            <input id="q" name="q" value="{{ $q }}" placeholder="Código, nombre o categoría">
        </div>
        <div class="field">
